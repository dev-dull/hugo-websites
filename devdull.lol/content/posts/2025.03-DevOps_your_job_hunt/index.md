...
{{% notice tip %}}
Update (June, 2025): For more standardized format, Check out the [JSON Resume schema website](https://jsonresume.org/schema), or visit their [GitHub page](https://github.com/jsonresume/jsonresume.org).
{{% /notice %}}
